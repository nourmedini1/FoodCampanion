...
class ModifyEmailWidget extends StatefulWidget {
  ...
  @override
  State<ModifyEmailWidget> createState() => _ModifyUsernameWidgetState();
}

class _ModifyUsernameWidgetState extends State<ModifyEmailWidget> {
  ...
  Padding confirm(BuildContext context, String email) {
    return Padding(
