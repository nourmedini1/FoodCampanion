...
class ModifyCountryWidget extends StatefulWidget {
  const ModifyCountryWidget({super.key});

  @override
  State<ModifyCountryWidget> createState() => _ModifyUsernameWidgetState();
}

class _ModifyUsernameWidgetState extends State<ModifyCountryWidget> {
  ...
  Padding confirm(BuildContext context, String country) {
    return Padding(
