    ...
    on<UsersEvent>((event, emit) async {
      if (event is UsersSignInEvent) {
        ...
        result.fold(
            ...
            (model) => emit(UsersSuccessState(
                successMessage: SIGN_IN_SUCCESS_MESSAGE, userEntity: model)));
        ...
        result.fold(
            ...
            (unit) => emit(const UsersSuccessState(
                successMessage: LOG_IN_SUCCESS_MESSAGE, userEntity: null)));
        ...
        result.fold(
            (failure) => emit(UsersDeleteErrorState(
                errorMessage: mapFailureToMessage(failure))),
            (unit) => emit(const UsersDeleteSuccessState(
